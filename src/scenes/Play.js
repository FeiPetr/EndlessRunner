class Play extends Phaser.Scene{ //creating js class 'menu' that extends phaser's predef scene object
    ...
    create(){
        ...
        this.livesLeft = this.add.text(borderUISize + borderPadding+200, borderUISize + borderPadding*2, this.lifeScore, scoreConfig);
     ...
     update() {
        ...
        if(!this.gameOver){
          ...
          this.bgtile.tilePositionX += this.elapsed*0.1+2; // making background scroll
            ...
            this.orange.x -= this.elapsed*0.1+2;
            this.orange2.x -= this.elapsed*0.1+2;
            this.ice_cream.x -=this.elapsed*0.1+2;
            this.ice_cream2.x -=this.elapsed*0.1+2;
            this.orange.update();
          ...
          if(this.checkCollision(this.character, this.ice_cream))
          {
          ...
          this.livesLeft.text = this.lifeScore;
          if(this.lifeScore <= 0)
          {
